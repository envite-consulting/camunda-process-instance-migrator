...
class PerformMigrationOperatonImplTest {
  ...
  private PerformMigrationOperatonImpl performMigration;

  private static final String PROCESS_INSTANCE_ID = "instance-1";

  @BeforeEach
  void setUp() {
    performMigration = new PerformMigrationOperatonImpl(processEngine);
  ...
  @Test
  void should_pass_variables_to_operaton_migration_plan() {
