...
class PerformMigrationCamundaImplTest {
  ...
  private PerformMigrationCamundaImpl performMigration;

  private static final String PROCESS_INSTANCE_ID = "instance-1";

  @BeforeEach
  void setUp() {
    performMigration = new PerformMigrationCamundaImpl(processEngine);
