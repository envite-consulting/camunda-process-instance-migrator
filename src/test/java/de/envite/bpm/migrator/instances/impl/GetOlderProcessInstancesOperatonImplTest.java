...
class GetOlderProcessInstancesOperatonImplTest {
  ...
  @InjectMocks private GetOlderProcessInstancesOperatonImpl getOlderProcessInstancesOperatonImpl;
  ...
  void getOlderProcessInstances_should_get_older_process_instances() {
    ...
    List<VersionedProcessInstance> result =
        getOlderProcessInstancesOperatonImpl.getOlderProcessInstances(
