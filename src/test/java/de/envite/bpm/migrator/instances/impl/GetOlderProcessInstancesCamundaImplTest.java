...
class GetOlderProcessInstancesCamundaImplTest {
  ...
  @InjectMocks private GetOlderProcessInstancesCamundaImpl getOlderProcessInstancesCamundaImpl;
  ...
  void setup() {
    ...
    mockProcessDefinitionQuery(repositoryService)
        .list(asList(processDefinitionResult1, processDefinitionResult2, processDefinitionResult3));
    mockProcessInstanceQuery(runtimeService)
        .list(asList(processInstanceResult1, processInstanceResult2));
  ...
  void getOlderProcessInstances_should_get_older_process_instances() {
    ...
    List<VersionedProcessInstance> result =
        getOlderProcessInstancesCamundaImpl.getOlderProcessInstances(
